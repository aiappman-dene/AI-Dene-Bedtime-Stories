...
const UI_STRINGS = {
  "en-GB": {
    ...
    card_quick_name: "Quick Dream",
    card_quick_dur: "5\u20137 min",
    card_quick_desc: "A short, sweet story",
    card_magic_name: "Magic Adventure",
    card_magic_dur: "10+ min",
    card_magic_desc: "A full magical journey",
    card_sleepy_name: "Sleepy Story",
    card_sleepy_dur: "Calm & relaxing",
    card_sleepy_desc: "Gentle & soothing",
    card_custom_name: "Custom Story",
    card_custom_dur: "Your idea",
    card_custom_desc: "Tell us what you want",
    card_custom_new: "New",
  ...
  "fr": {
    ...
    card_quick_name: "R\u00eave Rapide",
    card_quick_dur: "5\u20137 min",
    card_quick_desc: "Une histoire courte et douce",
    card_magic_name: "Grande Aventure",
    card_magic_dur: "10+ min",
    card_magic_desc: "Un voyage magique complet",
    card_sleepy_name: "Histoire Douce",
    card_sleepy_dur: "Calme & reposant",
    card_sleepy_desc: "Douce & apaisante",
    card_custom_name: "Histoire Perso",
    card_custom_dur: "Votre id\u00e9e",
    card_custom_desc: "Dites-nous ce que vous voulez",
  ...
  "es": {
    ...
    card_quick_name: "Sue\u00f1o R\u00e1pido",
    card_quick_dur: "5\u20137 min",
    card_quick_desc: "Una historia corta y dulce",
    card_magic_name: "Gran Aventura",
    card_magic_dur: "10+ min",
    card_magic_desc: "Un viaje m\u00e1gico completo",
    card_sleepy_name: "Historia Suave",
    card_sleepy_dur: "Calma & relajante",
    card_sleepy_desc: "Suave & reconfortante",
    card_custom_name: "Historia Propia",
    card_custom_dur: "Tu idea",
    card_custom_desc: "D\u00ednos qu\u00e9 quieres",
  ...
  "pt": {
    ...
    card_quick_name: "Sonho R\u00e1pido",
    card_quick_dur: "5\u20137 min",
    card_quick_desc: "Uma hist\u00f3ria curta e doce",
    card_magic_name: "Grande Aventura",
    card_magic_dur: "10+ min",
    card_magic_desc: "Uma jornada m\u00e1gica completa",
    card_sleepy_name: "Hist\u00f3ria Suave",
    card_sleepy_dur: "Calma & relaxante",
    card_sleepy_desc: "Suave & reconfortante",
    card_custom_name: "Hist\u00f3ria Pr\u00f3pria",
    card_custom_dur: "Sua ideia",
    card_custom_desc: "Diga-nos o que quer",
  ...
  "de": {
    ...
    card_quick_name: "Schneller Traum",
    card_quick_dur: "5\u20137 Min",
    card_quick_desc: "Eine kurze, s\u00fc\u00dfe Geschichte",
    card_magic_name: "Gro\u00dfes Abenteuer",
    card_magic_dur: "10+ Min",
    card_magic_desc: "Eine vollst\u00e4ndige magische Reise",
    card_sleepy_name: "Schlafgeschichte",
    card_sleepy_dur: "Ruhig & entspannend",
    card_sleepy_desc: "Sanft & beruhigend",
    card_custom_name: "Eigene Geschichte",
    card_custom_dur: "Deine Idee",
    card_custom_desc: "Erz\u00e4hl uns, was du willst",
    card_custom_new: "Neu",
  ...
  "it": {
    ...
    card_quick_name: "Sogno Rapido",
    card_quick_dur: "5\u20137 min",
    card_quick_desc: "Una storia breve e dolce",
    card_magic_name: "Grande Avventura",
    card_magic_dur: "10+ min",
    card_magic_desc: "Un viaggio magico completo",
    card_sleepy_name: "Storia Dolce",
    card_sleepy_dur: "Calma & rilassante",
    card_sleepy_desc: "Delicata & rilassante",
    card_custom_name: "Storia Personale",
    card_custom_dur: "La tua idea",
    card_custom_desc: "Dicci cosa vuoi",
  ...
  "ja": {
    ...
    card_quick_name: "クイックドリーム",
    card_quick_dur: "5〜7分",
    card_quick_desc: "短くて甘い物語",
    card_magic_name: "魔法の冒険",
    card_magic_dur: "10分以上",
    card_magic_desc: "完全な魔法の旅",
    card_sleepy_name: "眠り物語",
    card_sleepy_dur: "穏やか・癒し",
    card_sleepy_desc: "やさしく落ち着く",
    card_custom_name: "オリジナル物語",
    card_custom_dur: "あなたのアイデア",
    card_custom_desc: "何が聞きたいか教えて",
    card_custom_new: "新着",
  ...
  "zh-CN": {
    ...
    card_quick_name: "快速梦境",
    card_quick_dur: "5\u20137 分钟",
    card_quick_desc: "简短温馨的故事",
    card_magic_name: "魔法冒险",
    card_magic_dur: "10+ 分钟",
    card_magic_desc: "完整的魔法之旅",
    card_sleepy_name: "安眠故事",
    card_sleepy_dur: "平静放松",
    card_sleepy_desc: "温柔舒缓",
    card_custom_name: "自定义故事",
    card_custom_dur: "您的想法",
    card_custom_desc: "告诉我们你想要什么",
    card_custom_new: "新",
  ...
  "ar": {
    ...
    card_quick_name: "حلم سريع",
    card_quick_dur: "5\u20137 دقائق",
    card_quick_desc: "قصة قصيرة وجميلة",
    card_magic_name: "مغامرة سحرية",
    card_magic_dur: "10+ دقائق",
    card_magic_desc: "رحلة سحرية كاملة",
    card_sleepy_name: "قصة النوم",
    card_sleepy_dur: "هادئة ومريحة",
    card_sleepy_desc: "لطيفة ومهدئة",
    card_custom_name: "قصتي الخاصة",
    card_custom_dur: "فكرتك",
    card_custom_desc: "أخبرنا ماذا تريد",
  ...
  "hi": {
    ...
    card_quick_name: "त्वरित सपना",
    card_quick_dur: "5\u20137 मिनट",
    card_quick_desc: "एक छोटी, प्यारी कहानी",
    card_magic_name: "जादुई साहसिक",
    card_magic_dur: "10+ मिनट",
    card_magic_desc: "एक पूर्ण जादुई यात्रा",
    card_sleepy_name: "नींद की कहानी",
    card_sleepy_dur: "शांत और आरामदायक",
    card_sleepy_desc: "कोमल और सुखदायक",
    card_custom_name: "अपनी कहानी",
    card_custom_dur: "आपका विचार",
    card_custom_desc: "हमें बताएं आप क्या चाहते हैं",
    card_custom_new: "नया",
  ...
  "ur": {
    ...
    card_quick_name: "فوری خواب",
    card_quick_dur: "5\u20137 منٹ",
    card_quick_desc: "ایک چھوٹی، پیاری کہانی",
    card_magic_name: "جادوئی مہم",
    card_magic_dur: "10+ منٹ",
    card_magic_desc: "ایک مکمل جادوئی سفر",
    card_sleepy_name: "نیند کی کہانی",
    card_sleepy_dur: "پُرسکون اور آرام دہ",
    card_sleepy_desc: "نرم اور سکون بخش",
    card_custom_name: "اپنی کہانی",
    card_custom_dur: "آپ کا خیال",
    card_custom_desc: "ہمیں بتائیں آپ کیا چاہتے ہیں",
    card_custom_new: "نیا",
...
function updateStreakDisplay() {
  ...
  const nightWord = streak.count === 1 ? t("streak_night") : t("streak_nights");
  el.textContent = `🌙 ${name} · ${streak.count} ${nightWord} ${t("streak_row")}`;
